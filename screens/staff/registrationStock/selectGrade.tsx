...
type RegistrationStockSelectGradeProps = {
  grades?: Grade[];
};

const RegistrationStockSelectGradeScreen: React.FC<
  RegistrationStockSelectGradeProps
> = ({ grades }) => {
...
export default RegistrationStockSelectGradeScreen;
