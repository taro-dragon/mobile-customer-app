...
type RegistrationStockSelectMakerScreenProps = {
  manufacturers: Manufacture[];
};

const RegistrationStockSelectMakerScreen: React.FC<
  RegistrationStockSelectMakerScreenProps
> = ({ manufacturers }) => {
  ...
  const handleMakerSelect = useCallback(
    (manufacturerId: string) => {
      ...
      setTimeout(() => {
        router.push("/registrationStock/selectCar");
      }, 50);
    },
    [onChange, router]
  );
...
export default RegistrationStockSelectMakerScreen;
